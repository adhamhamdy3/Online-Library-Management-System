...
Librarian::Librarian(Library &lib, const string &n, const int &ag, const string &g, const int &phn) : library(lib), User(n, ag, g, phn){

}

Librarian::Librarian(Library &lib) : library(lib) {
}
